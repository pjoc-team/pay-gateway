...
echo "sign===$sign"
json='{"pay_amount":1, "out_trade_no": "'${orderId}'", "order_time":"'${nowDate}'", "app_id":"1", "channel_id":"demo", "sign_type":"RSA", "method":"test", "sign":"'$sign'"}'
echo "final json: $json"
curl -d "$json" "http://127.0.0.1:18080/v1/pay/test"