...
func TestSignPKCS1v15(t *testing.T) {
	...
	sign, _ := PKCS1v15([]byte(s), []byte(privateKey), crypto.SHA256)
...
func TestSignPKCS1v15WithStringKey(t *testing.T) {
	...
	sign, _ := PKCS1v15WithStringKey([]byte(s), privateKeyStr, crypto.SHA256)
	fmt.Println(base64.StdEncoding.EncodeToString(sign))
...
-----END PUBLIC KEY-----`
	...
	sign, err := PKCS1v15([]byte(message), []byte(privateKey), crypto.SHA256)
	if err != nil {
