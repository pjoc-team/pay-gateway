...
import (
	...
	gw "github.com/pjoc-team/pay-proto/go"
)
...
func SetupMux(ctx context.Context, cfg proxyConfig) *http.ServeMux {
	...
	// If you get a compilation error that gw.RegisterPayGatewayHandlerFromEndpoint
	// does not exist, it's because you haven't added any google.api.http annotations
	// to your proto. Add some!
	err := gw.RegisterPayGatewayHandlerFromEndpoint(ctx, gwmux, cfg.backend, opts)
	if err != nil {
