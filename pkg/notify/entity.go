...
func (g *UrlGenerator) GenerateSignByPayOrderOk(ctx context.Context, payOrderOk pay.PayOrderOk) (str string, err error) {
...
func (g *UrlGenerator) GenerateUrlByPayOrderOk(ctx context.Context, payOrderOk pay.PayOrderOk) (url string, form url.Values, err error) {
	log := logger.ContextLog(ctx)
